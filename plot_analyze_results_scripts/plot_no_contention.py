...
def plot_no_contention_noise(plot_path, results_dict, noise_dict, file_factor, best_algorithm_on_average, workflows,platform_to_use):
	...
	contentionV=results_dict[noise_dict]
